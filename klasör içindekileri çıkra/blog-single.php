...
<main id="main" class="col-md-8">
					<div class="blog">
						<div class="blog-img">
							<img class="img-fluid" src="includes/img/blog-post.jpg" alt="">
						</div>
				...
				<aside id="aside" class="col-md-4">
					...
					<div class="widget">
						...
						<div class="widget-post">
							<a href="#">
								<img class="img-fluid" src="includes/img/post1.jpg" alt=""> Lorem Ipsum
							</a>
							<ul class="blog-meta">
								<li>Oct 18, 2017</li>
							</ul>
						...
						<div class="widget-post">
							<a href="#">
								<img class="img-fluid" src="includes/img/post2.jpg" alt=""> Lorem Ipsum
							</a>
							<ul class="blog-meta">
								<li>Oct 18, 2017</li>
							</ul>
						...
						<div class="widget-post">
							<a href="#">
								<img class="img-fluid" src="includes/img/post3.jpg" alt=""> Lorem Ipsum
							</a>
							<ul class="blog-meta">
								<li>Oct 18, 2017</li>
							</ul>
